...
public class BLE_Advertise_Service extends Service {
    ...
    * */
    ...
    private AdvertiseData buildAdvertiseData() {
        ...
        dataBuilder.addServiceData(Constants.Service_UUID, data.getBytes());
    ...
    private void setTimeout(){
        ...
        timeoutRunnable = new Runnable() {
            @Override
            public void run() {
                Log.d(DEBUG, "AdvertiserService has reached timeout of "+TIMEOUT+" milliseconds, stopping advertising.");
                scheduleNextService();
                stopSelf();
            }
        };
